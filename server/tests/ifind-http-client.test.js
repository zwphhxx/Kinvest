...
async function run() {
  ...
  assert.deepEqual(
    ...
    ['diagnose', 'authenticate', 'quote', 'financial', 'calibrateFinancial']
  )
  ...
  assert.deepEqual(Object.keys(client), ['diagnose', 'authenticate', 'quote', 'financial', 'calibrateFinancial'])
  ...
  assert.deepEqual(Object.keys(clearClient), ['diagnose', 'authenticate', 'quote', 'financial', 'calibrateFinancial'])
